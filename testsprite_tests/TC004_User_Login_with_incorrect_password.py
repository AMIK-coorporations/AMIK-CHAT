...
async def run_test():
    ...
    try:
        ...
        # -> Enter registered email 'qtyabdullahfarooq12@gmail.com' and incorrect password '12345678' into the login form.
        ...
        frame = context.pages[-1]
        await expect(frame.locator('text=لوڈ ہو رہا ہے').first).to_be_visible(timeout=30000)
