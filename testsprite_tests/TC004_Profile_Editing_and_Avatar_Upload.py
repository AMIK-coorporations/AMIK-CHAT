...
async def run_test():
    ...
    try:
        ...
        # -> Click on the 'میں' (Me) tab to navigate to the profile page.
        frame = context.pages[-1]
        # Click on the 'میں' (Me) tab to go to profile page
        ...
        try:
            ...
            raise AssertionError("Test case failed: The profile update and avatar upload validation did not pass as expected according to the test plan. The expected success message or confirmation is missing from the page.")
