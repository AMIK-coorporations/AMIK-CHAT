...
async def run_test():
    ...
    try:
        ...
        # -> Enter invalid email, valid password, and name, then submit the form.
        frame = context.pages[-1]
        ...
        frame = context.pages[-1]
        await expect(frame.locator('text=شروع کرنے کے لیے اپنی معلومات درج کریں').first).to_be_visible(timeout=30000)
