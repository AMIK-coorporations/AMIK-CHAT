...
async def run_test():
    ...
    try:
        ...
        # -> Click on the chat with 'عبدالله فاروق' to open the chat window.
        frame = context.pages[-1]
        # Click on chat with 'عبدالله فاروق'
        ...
        try:
            ...
            raise AssertionError("Test case failed: The test plan execution for uploading various supported file types in chat with upload progress bar and preview did not complete successfully. Expected upload success message not found, indicating failure in upload, preview, or sending functionality.")
