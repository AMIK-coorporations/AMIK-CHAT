...
async def run_test():
    ...
    try:
        ...
        # -> Click on contact 'عبدالله فاروق' to open chat
        frame = context.pages[-1]
        # Click on contact 'عبدالله فاروق' to open chat
        ...
        try:
            ...
            raise AssertionError("Test case failed: Users cannot send and receive messages in real-time with latency under 1 second as required by the test plan.")
