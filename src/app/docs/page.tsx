...
export default function DocsPage() {
    ...
    const categories = [
        {
            title: "شروعات",
            description: "اکاؤنٹ بنانے اور پہلی بار لاگ ان کے بارے میں معلومات حاصل کریں۔",
            icon: Rocket,
        ...
        },
        {
            ...
            description: "پیغام رسانی، کالنگ اور فائلیں بانٹنے کے بارے میں جانیں۔",
            icon: MessageCircle,
        ...
        <div className="space-y-12 py-6">
            <section className="text-center space-y-4">
                ...
                <p className="text-xl text-muted-foreground mx-auto max-w-2xl">
                    اے ایم آئی کے چیٹ کی تمام خصوصیات اور ان کو استعمال کرنے کے طریقوں کے بارے میں یہاں تفصیلی رہنمائی حاصل کریں۔
                </p>
            </section>
