        ...
        <div className="flex flex-col min-h-screen bg-background">
            ...
            <main className="flex-1 p-6 max-w-4xl mx-auto prose dark:prose-invert">
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Privacy Policy) refers to AMIK CHAT.</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p><strong>Website</strong> refers to AMIK CHAT, accessible from <a href="https://amikchat.site" rel="external nofollow noopener" target="_blank">https://amikchat.site</a>.</p>
                    </li>
                    <li>
                ...
                <ul>
                    <li>By email: info@amikchat.site</li>
                </ul>
            </main>
        </div>
    );
